...
If you want to work on **ArrAPI.Auth**, make sure you have [.NET 10.0 SDK](https://dotnet.microsoft.com/download/dotnet/10.0) installed and [Rider](https://www.jetbrains.com/rider).
