...
If you want to work on **ArrAPI.Auth**, make sure you have [.NET 9.0 SDK](https://dotnet.microsoft.com/download/dotnet/9.0) installed and [Visual Studio](https://www.visualstudio.com/vs).
